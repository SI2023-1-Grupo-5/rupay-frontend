...
`;
const ConfirmaoDeComentrioModaRoot = styled.div`
  position: relative;
  ...
  font-family: var(--font-inter);
`;
const SucessesComment = () => {
  const onButtonClick = useCallback(() => {
    // Please sync "Login" to the project
  }, []);

  return (
    <ConfirmaoDeComentrioModaRoot>
      <PagamentoConfirmado>Comentário enviado!</PagamentoConfirmado>
      <Head>
...
export default SucessesComment;
