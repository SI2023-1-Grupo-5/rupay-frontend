...
const PagamentoConfirmado1 = styled.p`
  margin: 0;
`;
...
`;
const ConfirmaoDePagamentoModalRoot = styled.div`
  position: relative;
...
const SucessesPay = () => {
  ...
  return (
    <ConfirmaoDePagamentoModalRoot>
      <PagamentoConfirmado>
        <PagamentoConfirmado1>Pagamento confirmado!</PagamentoConfirmado1>
      </PagamentoConfirmado>
      <Head>
